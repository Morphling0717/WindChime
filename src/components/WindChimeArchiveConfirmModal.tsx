...
const DEFAULT_THEME: Required<WindChimeArchiveConfirmModalTheme> = {
  ...
  wrap: "relative w-full max-w-md rounded-2xl border border-amber-300 bg-white p-6 shadow-[0_10px_40px_rgba(251,191,36,0.25)] dark:border-amber-400/60 dark:bg-slate-900",
  closeButton:
  ...
  title: "text-sm font-bold tracking-wider text-amber-700 dark:text-amber-200",
  ...
  busyHint:
    "mt-3 text-center font-mono text-[11px] text-sky-700/80 dark:text-cyan-300/80",
};
    ...
    >
      ...
      >
        ...
        <div className={th.buttonsWrap}>
          ...
          >
            <div className={th.primaryActionHeading}>
              {L.markReadFirstHeading}
            </div>
          ...
          >
            <div className={th.secondaryActionHeading}>
              {L.archiveAnywayHeading}
            </div>
